          ...
          <div className="flex justify-center items-center mt-4">
            <div className="flex flex-col items-center">
              ...
              <div className="text-lg font-semibold text-blueGray-700">
                {device.lastRecord?.valor1} <span className="font-light">{getUnit(device.param1)}</span>
              </div>
            </div>
            {/* <div className="flex flex-col items-center">
              <div className="text-sm text-emerald-500">
              ...
              <div className="text-lg font-semibold text-blueGray-700">
                {device.lastRecord?.valor2} <span className="font-light">{getUnit(device.param2)}</span>
              </div>
            </div>
            <div className="flex flex-col items-center">
              <div className="text-sm text-emerald-500">
              ...
              <div className="text-lg font-semibold text-blueGray-700">
                {device.lastRecord?.valor3} <span className="font-light">{getUnit(device.param3)}</span>
              </div>
            </div> */}
          </div>
        </div>
